...
In the late 1 94 0 s the term NLP wasn ’ t in existence, but the work regarding machine translation
...
naïve bayes is preferred because of its performance despite its simplicity (Lewis, 1 99 8) [ 6 7 ] In
...
on sequence modeling. ar Xiv preprint ar Xiv:1 41 2.3 55 5
...
and summarizing documents. Inf Process Manag 4 3(6):1 58 8 – 1 60 5
...
scale nlp tasks. ar Xiv preprint ar Xiv:1 60 2.0 62 91
...
networks-ddad 72 c 70 48 c . Accessed 1 5 Dec 2 02 1
...
Transactions on Circuits and Systems for Video Technology 3 0(1 1):4 36 8 – 4 37 9
...
language processor from English to French. Medinfo 8 9:7 95 – 7 99
...
to Expedite GDPR Compliance." Stock Market. PR Newswire, n.d. Web. 1 9
...
2 01 8 international conference on information Systems and computer aided education (ICISCAE) (pp. 6 4-
7 0). IEEE
...
filtering Systems. IEEE Access 8:8 26 53 – 8 26 61. https://doi.org/1 0.1 10 9/ACCESS.2 02 0.2 99 13 28
## 1 54. Xie P, Xing E (2 01 7) A constituent-centric neural architecture for reading comprehension. In proceedings

of the 5 5 th annual meeting of the Association for Computational Linguistics (volume 1: long papers) (pp.
1 40 5-1 41 4)
## 1 55. Yan X, Ye Y, Mao Y, Yu H (2 01 9) Shared-private information bottleneck method for cross-modal

clustering. IEEE Access 7:3 60 45 – 3 60 56
## 1 56. Yi J, Nasukawa T, Bunescu R, Niblack W (2 00 3) Sentiment analyzer: extracting sentiments about a given

topic using natural language processing techniques. In data mining, 2 00 3. ICDM 2 00 3. Third IEEE
international conference on (pp. 4 27-4 34). IEEE
## 1 57. Young SJ, Chase LL (1 99 8) Speech recognition evaluation: a review of the US CSR and LVCSR

programmes. Comput Speech Lang 1 2(4):2 63 – 2 79
...
email threads using sentence compression. Inf Process Manag 4 4(4):1 60 0 – 1 61 0
## 1 60. Zeroual I, Lakhouaja A, Belahbib R (2 01 7) Towards a standard part of speech tagset for the Arabic

language. J King Saud Univ Comput Inf Sci 2 9(2):1 71 – 1 78
